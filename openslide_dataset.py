...
class LabeledOpenSlideDataset(chainer.dataset.DatasetMixin):
    # patch fetching modes
    # - 'area'    (default) uniformly selects from all the regions (slide with small region area is rarely selected)
    # - 'slide'   uniform slide selection, uniform position selection
